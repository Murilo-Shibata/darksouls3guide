  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "ember-pulse": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(var(--ember) / 0.5), 0 0 40px hsl(var(--ember) / 0.3)" 
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(var(--ember) / 0.8), 0 0 80px hsl(var(--ember) / 0.5)" 
          },
        },
        "float-up": {
